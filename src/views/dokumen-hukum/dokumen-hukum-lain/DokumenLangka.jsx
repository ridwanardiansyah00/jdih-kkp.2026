...
function DokumenLangka() {
  ...
  const dataDokumenLangka = [
    {
      no: 1,
      jenis: "Staatsblad",
      nomor: "145/1927",
      judul:
        "Algemeene regelen voor de jacht op walvisschen binnen den afstand van drie zeemijlen van de kusten van Nederlandsch Indie",
      ditetapkan: "29 April 1927",
      diundangkan: "06 Mei 1927",
    ...
    },
    {
      ...
      nomor: "144/1927",
      judul:
        "Algemeene Regeling voor de Visscherij binnen het zeegebied van Nederlandsch Indie",
      ditetapkan: "29 April 1927",
      diundangkan: "29 April 1927",
      status: "Tidak Berlaku",
    },
    {
      no: 3,
      ...
      nomor: "396/1920",
      judul:
        "Visscherij Bepalingen ter Bescherming van den Vischsstand",
      ditetapkan: "26 Mei 1920",
      diundangkan: "20 Juni 1920",
      status: "Tidak Berlaku",
    },
    {
      no: 4,
      ...
      nomor: "628/1916",
      judul:
        "Wijziging en aanvulling van de Algemeene regelen voor het visschen naar Parelschelpen, Parelmoerschelpen, Teripang dan Sponsen binnen de afstand van niet meer dan drie Engelsche zeemijlen van de kusten van Nederlandsch Indie",
      ditetapkan: "11 Oktober 1916",
      diundangkan: "11 Oktober 1916",
      status: "Tidak Berlaku",
    },
  ];

  const filteredData = dataDokumenLangka.filter((item) =>
                ...
                <tbody className="text-[14px]">
                  {filteredData.slice(0, entries).map((item, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-center align-middle">
                        <span className="inline-flex items-center justify-center px-4 py-1 rounded-full text-sm font-semibold whitespace-nowrap bg-red-500 text-white">
                          {item.status}
                        </span>
                      </td>
                    </tr>
