...
function SurveiPersepsiAntiKorupsi() {
  return (
    <>
      <Navbar />
      ...
      <main className="pt-20 min-h-screen bg-slate-100">
        ...
        <section className="max-w-screen-2xl mx-auto px-6 lg:px-10 py-8">
          <div className="bg-white rounded-xl shadow border border-slate-200 p-6 md:p-8 min-h-150 flex items-center justify-center">
            <p className="text-slate-500 text-lg md:text-xl text-center">
              Konten survei persepsi anti korupsi dan kualitas pelayanan akan ditampilkan di sini
            </p>
          </div>
        </section>
      </main>
...
export default SurveiPersepsiAntiKorupsi;