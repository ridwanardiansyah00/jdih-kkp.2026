...
function RancanganPeraturan() {
  const [entries, setEntries] = useState(10);
  const [search, setSearch] = useState("");

  const dataRancanganPeraturan = [
    {
      no: 1,
      judul:
        "Peraturan Menteri Kelautan dan Perikanan Nomor 6 Tahun 2026 tentang Perubahan Kedua atas Peraturan Menteri Kelautan dan Perikanan Nomor 33 Tahun 2023 tentang Peraturan Pelaksanaan Peraturan Pemerintah Nomor 26 Tahun 2023 tentang Pengelolaan Hasil Sedimentasi di Laut",
      status: "Berlaku",
    },
    {
      no: 2,
    ...
    },
    {
      no: 4,
      judul:
        "Peraturan Menteri Kelautan dan Perikanan Nomor 2 Tahun 2026 tentang Pemberdayaan Usaha Mikro, Usaha Kecil, dan Usaha Menengah Sektor Kelautan dan Perikanan",
      status: "Berlaku",
    },
    {
      no: 5,
      judul:
        "Peraturan Menteri Kelautan dan Perikanan Nomor 3 Tahun 2026 tentang Jabatan dan Kelas Jabatan Pegawai di Lingkungan Kementerian Kelautan dan Perikanan",
      status: "Berlaku",
    },
  ];

  const filteredData = dataRancanganPeraturan.filter((item) =>
...
export default RancanganPeraturan;