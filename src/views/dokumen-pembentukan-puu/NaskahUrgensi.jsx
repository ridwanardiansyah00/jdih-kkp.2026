...
function NaskahUrgensi() {
  const [entries, setEntries] = useState(10);
  const [search, setSearch] = useState("");

  const dataNaskahUrgensi = [
    {
      no: 1,
      judul:
        "Naskah urgensi perubahan Peraturan Menteri Kelautan dan Perikanan terkait pengelolaan hasil sedimentasi di laut.",
      status: "Berlaku",
    },
    {
      no: 2,
      judul:
        "Naskah urgensi perubahan kebijakan pengelolaan lobster, kepiting, dan rajungan.",
      status: "Berlaku",
    },
    {
      no: 3,
      judul:
        "Naskah urgensi tata kelola pengawakan kapal perikanan dan sertifikasi awak kapal.",
      status: "Berlaku",
    },
    {
      no: 4,
      judul:
        "Naskah urgensi pemberdayaan UMKM sektor kelautan dan perikanan.",
      status: "Berlaku",
    },
    {
      no: 5,
      judul:
        "Naskah urgensi jabatan dan kelas jabatan pegawai di lingkungan KKP.",
      status: "Berlaku",
    },
  ];

  const filteredData = dataNaskahUrgensi.filter((item) =>
