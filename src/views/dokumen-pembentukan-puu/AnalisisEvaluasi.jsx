...
function AnalisisEvaluasi() {
  ...
  const dataAnalisisEvaluasi = [
    ...
    },
    {
      no: 3,
      judul:
        "Peraturan Menteri Kelautan dan Perikanan Nomor 21 Tahun 2025 tentang Pakan Ikan",
      status: "Berlaku",
    },
    {
      no: 4,
      judul:
        "Peraturan Menteri Kelautan dan Perikanan Nomor 10 Tahun 2025 tentang Pelaksanaan Pemberian Tunjangan Kinerja di Lingkungan Kementerian Kelautan dan Perikanan",
      status: "Berlaku",
    },
  ];

  const filteredData = dataAnalisisEvaluasi.filter((item) =>
