...
function ProgramPenyusunan() {
  ...
  const dataProgramPenyusunan = [];

  const filteredData = dataProgramPenyusunan.filter((item) =>
          ...
          <div className="bg-white rounded-xl shadow border border-slate-200 p-4 md:p-5">
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-blue-950 text-white">
                    ...
                    <th className="px-4 py-3 text-center font-semibold w-[56%]">
                      Judul
                    </th>

                    <th className="px-4 py-3 text-center font-semibold w-[18%]">
                      Status
                    </th>
                  ...
                  {filteredData.length > 0 ? (
                    filteredData.slice(0, entries).map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-center align-middle">
                          <button className="inline-flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition">
                            <FaFilePdf />
                            PDF
                          </button>
                        </td>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-5 text-sm text-slate-600">
              <div>
                ...
                {Math.min(entries, filteredData.length)} dari{" "}
